...
from analysis.seasonality_checker import box_plot
...
path = '%s/pollution_data/cut_data' % Path(__file__).parent
path_to_file = '%s/Centar_PM25_with_features.csv' % path
...
out_file = get_autosave_path(path_to_file, 'with_features')
