...
from myarima.arima_selection import AutoArimaSelection
...
path_prepared = '%s/pollution_data/cut_data' % Path(__file__).parents[1]
path_out = '%s/pollution_data/arima_selection_results/1' % Path(__file__).parents[1]
